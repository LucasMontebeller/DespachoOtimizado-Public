...
namespace DespachoOtimizado.Infra.Data.Migrations
{
    ...
    [Migration("20230728143254_CreateEstrada")]
    partial class CreateEstrada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DespachoOtimizado.Domain.Entities.Estrada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte>("EstradaSubTipoId")
                        .HasColumnType("tinyint");

                    b.Property<byte>("EstradaTipoId")
                        .HasColumnType("tinyint");
                    ...
                    b.Property<decimal>("VelocidadeMedia")
                        .HasColumnType("numeric(4,1)");

                    b.HasKey("Id")
                        .HasName("PK_Estrada_Id");

                    b.HasIndex("EstradaSubTipoId");

                    b.HasIndex("EstradaTipoId");

                    b.ToTable("Estrada");
                });

            modelBuilder.Entity("DespachoOtimizado.Domain.Entities.EstradaSubTipo", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_EstradaSubTipo_Id");

                    b.ToTable("EstradaSubTipo");
                });

            modelBuilder.Entity("DespachoOtimizado.Domain.Entities.EstradaTipo", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_EstradaTipo_Id");

                    b.ToTable("EstradaTipo");
                });
            ...
            modelBuilder.Entity("DespachoOtimizado.Domain.Entities.Estrada", b =>
                {
                    b.HasOne("DespachoOtimizado.Domain.Entities.EstradaSubTipo", "EstradaSubTipo")
                        .WithMany()
                        .HasForeignKey("EstradaSubTipoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Estrada_EstradaSubTipo");

                    b.HasOne("DespachoOtimizado.Domain.Entities.EstradaTipo", "EstradaTipo")
                        .WithMany()
                        .HasForeignKey("EstradaTipoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Estrada_EstradaTipo");

                    b.Navigation("EstradaSubTipo");

                    b.Navigation("EstradaTipo");
                });
